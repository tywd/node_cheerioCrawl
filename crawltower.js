 ...
 * @LastEditTime: 2020-08-31 19:01:41
 * @Description: 需要登录的如何爬
 */
const superagent = require('superagent');
const cheerio = require('cheerio');
var fs = require("fs");//引入文件读写的模块
var xlsx = require("node-xlsx");//引入要用于导出excel的模块
const url = 'https://tower.im/projects/331c3625c6b54d41aa28366d95af6538/lists/7821747ed489f75b229cd402c7877d2c/show/';
...
superagent.get(url).end( function(err, res) {
    ...
    // $('tr-todo-item').map((e,i) => {
    //     console.log($(this).attr('url'))
    // })
    // constellation.name = .trim();
